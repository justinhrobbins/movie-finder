    ...
    return (
        <div className="ActorAlertSummaryCard">
            ...
            <div className="actor-alert-data-card-actor-summary">
                <div className="actor-alert-data-card-total-actors"><Link className="actor-detail-alert-data-card-link" to={`/actoralerts?sort=${sortParam}&filter=all`} title="Show all your actors">Actors followed: {actors.actorCounts.actorCount}</Link></div>
                <div className="actor-alert-data-card-upcoming-releases"><Link className="actor-detail-alert-data-card-link" to={`/actoralerts?sort=${sortParam}&filter=upcoming`} title="Filter by upcoming releases">Actors with upcoming releases: {actors.actorCounts.upcomingMovieCount}</Link></div>
                <div className="actor-alert-data-card-recent-releases"><Link className="actor-detail-alert-data-card-link" to={`/actoralerts?sort=${sortParam}&filter=recent`} title="Filter by recent releases">Actors with recent releases: {actors.actorCounts.recentMovieCount}</Link></div>
                <div className="actor-alert-data-card-recent-releases"><Link className="actor-detail-alert-data-card-link" to={`/actoralerts?sort=${sortParam}&filter=subscriptions`} title="Filter by subscriptions">Actors with movies on your subscriptions: {actors.actorCounts.subscriptionCount}</Link></div>
            </div>
        </div>
    );
}